...
- Original documentation: <https://www.ee.ic.ac.uk/hp/staff/dmb/voicebox/voicebox.html>

## License

pyvoicebox is distributed under the **GNU Lesser General Public License v3.0 or later (LGPL-3.0-or-later)**, matching the upstream MATLAB toolbox. See [`LICENSE`](https://github.com/MFA-X-AI/pyvoicebox/blob/master/LICENSE) and [`LICENSE.GPL`](https://github.com/MFA-X-AI/pyvoicebox/blob/master/LICENSE.GPL).
